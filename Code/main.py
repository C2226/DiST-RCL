...
def run(evaluation_epoch=10):
    ...
    data_dir2 = os.path.join(data_dir, "metadata.json")
    print("data_dir2:", data_dir2)
    metadata = read_json(data_dir2)
    ...
    train_dl = DataLoader(train_data, batch_size=params["batch_size"], shuffle=True, collate_fn=collate,
                          pin_memory=True)
